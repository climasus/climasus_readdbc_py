...
from climasus_readdbc_py._blast import BlastError, _construct, blast_decompress
...
class TestConstruct:
    def test_litlen_expands_to_256(self):
        ...
        from climasus_readdbc_py._blast import _LITLEN
    ...
    def test_lenlen_expands_to_16(self):
        from climasus_readdbc_py._blast import _LENLEN
        count, symbol = _construct(_LENLEN)
        total = sum(count)
        assert total == 16

    def test_distlen_expands_to_64(self):
        from climasus_readdbc_py._blast import _DISTLEN
